...
\mode<presentation>
{
  % \usetheme[hideothersubsections, right]{Darmstadt}
  % \usetheme[hideothersubsections, right]{Hannover}
  % \usetheme[hideothersubsections, right]{Goettingen}
  % \usetheme[hideothersubsections, right]{Berkeley}
  % \usetheme[hideothersubsections, right]{Dresden}
  \usetheme{AnnArbor}
...
\title[Reprodutibilidade] % (optional, use only with long paper titles)
